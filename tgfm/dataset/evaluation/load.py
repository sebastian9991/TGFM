...
def load_data(dataset: str, seed: int = 0) -> Tuple[Data, List, List[str], List[str]]:
    if dataset == 'cora':
        ...
        c_descs = [
            ...
            ' which refers to research papers revolving around the concept of artificial neural networks (ANNs). Neural networks are a subset of machine learning algorithms modelled after the human brain, designed to '
            'learn'
            ' from observational data. They are the foundation of deep learning technologies and can process complex data inputs, find patterns, and make decisions. The network consists of interconnected layers of nodes, or '
            'neurons'
        ...
        from data.data_utils.load_arxiv_2023 import (
        ...
        from data.data_utils.load_instagram import (
