...
class MAG240MDataset(object):
    """Local OGB MAG240M implementation. Current codebase breaks with weights_only=True."""
    ...
    def __init__(self, root: str = 'dataset'):
        ...
        self.__split__ = torch.load(
            osp.join(self.dir, 'split_dict.pt'), weights_only=False
        )
    ...
    def edge_index(self, id1: str, id2: str, id3: Optional[str] = None) -> np.ndarray:
        src = id1
...
class MAG240MEvaluator:
    ...
    def save_test_submission(self, input_dict: Dict, dir_path: str, mode: str) -> None:
